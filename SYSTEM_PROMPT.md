...
**Versão atual:** **v0.12** (deployada 2026-05-26 — few-shot com 2 exemplos + anti-cópia + tabela de dias úteis determinística + regras de variação por fala).
